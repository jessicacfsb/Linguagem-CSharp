...
namespace teste_entrada_de_dados {
    class Program {
        static void Main(string[] args) {
            ...
            Console.WriteLine("Salario 1: " + salario1.ToString("F2", CultureInfo.InvariantCulture));
            Console.WriteLine("Nome 2: " + nome2);
            Console.WriteLine("Salario 2: " + salario2.ToString("F2", CultureInfo.InvariantCulture));
